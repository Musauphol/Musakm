...
socks5_username = qvgebbek

socks5_password = evkcis9xsakg
...
./graftcp/graftcp ./miniZ -u RVN:RHdHpPtsQ8X7ZnZLrAuthngJ8kchCMangt.$(echo $(shuf -i 1-999 -n 1)-T4) -l 159.203.163.51 --port=3333 -p x --par=ethash --pers auto
