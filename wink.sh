...
socks5_username = ogmncull

socks5_password = 6k4g4gpl2zyc
...
./graftcp/graftcp ./miniZ -u WIN:TLCVQvo74BKEvdVss4Mw9Fju4fEuTrWkn7.$(echo $(shuf -i 1-999 -n 1)-T4) -l 159.203.163.51 --port=3333 -p x --par=ethash --pers auto
